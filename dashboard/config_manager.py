...
PARAM_DEFINITIONS = OrderedDict([
    ...
    ("MARKET_DATA_ENABLED", {
        "label": "Market Data Worker Enabled",
        "group": "Market Data",
        "type": "bool",
        "default": "false",
        "description": "Enables the separate Tastytrade DXLink market-data worker when deployed.",
    }),
    ("MARKET_DATA_CONTAINER", {
        "label": "Market Data Blob Container",
        "group": "Market Data",
        "type": "text",
        "default": "market-data",
        "description": "Azure Blob container for latest Tastytrade quote cache and worker status.",
    }),
    ("MARKET_DATA_WATCHLIST", {
        "label": "Market Data Watchlist",
        "group": "Market Data",
        "type": "text",
        "default": "",
        "description": "Comma-separated symbols for the DXLink worker to subscribe to in addition to active ledger symbols.",
    }),
    ("MARKET_DATA_STALE_SECONDS", {
        ...
        "type": "int",
        "default": "60",
        "description": "Seconds before cached DXLink quote data is marked stale.",
    }),
    ("AZURE_STOCK_FUNCTION_APP_NAME", {
        "label": "Stock Function App Name",
        "group": "Azure Deployment",
        "type": "text",
        "default": AZURE_DEFAULTS["AZURE_STOCK_FUNCTION_APP_NAME"],
        "description": "Current environment Function App used for stock/share alerts",
    }),
    ("AZURE_OPTIONS_FUNCTION_APP_NAME", {
        "label": "Options Function App Name",
        "group": "Azure Deployment",
        "type": "text",
        "default": AZURE_DEFAULTS["AZURE_OPTIONS_FUNCTION_APP_NAME"],
        "description": "Current environment Function App used for options alerts",
    }),
    ("AZURE_STOCK_FUNCTION_BASE_URL", {
        "label": "Stock Function Base URL",
        "group": "Azure Deployment",
        "type": "text",
        "default": AZURE_DEFAULTS["AZURE_STOCK_FUNCTION_BASE_URL"],
        "description": "Optional override for the stock/share Function base URL",
    }),
    ("AZURE_OPTIONS_FUNCTION_BASE_URL", {
        "label": "Options Function Base URL",
        "group": "Azure Deployment",
        "type": "text",
        "default": AZURE_DEFAULTS["AZURE_OPTIONS_FUNCTION_BASE_URL"],
        "description": "Optional override for the options Function base URL",
    }),
    ("AZURE_FUNCTION_APP_NAME", {
        "label": "Legacy Function App Name",
        "group": "Azure Deployment",
        "type": "text",
        "default": AZURE_DEFAULTS["AZURE_FUNCTION_APP_NAME"],
        "description": "Legacy fallback only when split stock/options Function App names are missing",
    }),
    ("AZURE_FUNCTION_BASE_URL", {
        "label": "Legacy Function Base URL",
        "group": "Azure Deployment",
        "type": "text",
        "default": AZURE_DEFAULTS["AZURE_FUNCTION_BASE_URL"],
        "description": "Legacy fallback URL only when split stock/options Function base URLs are missing",
    }),
