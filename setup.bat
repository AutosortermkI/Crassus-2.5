...
echo ====================================
echo   Crassus 2.5 — First Time Setup
echo ====================================
echo.
...
echo You'll need your Tastytrade API account number, OAuth client secret, and refresh token.
echo.

set /p TASTYTRADE_ACCOUNT_NUMBER="Enter your Tastytrade account number: "
if "!TASTYTRADE_ACCOUNT_NUMBER!"=="" (
    echo [ERROR] Tastytrade account number cannot be empty.
    exit /b 1
)

set /p TASTYTRADE_CLIENT_SECRET="Enter your Tastytrade OAuth client secret: "
if "!TASTYTRADE_CLIENT_SECRET!"=="" (
    echo [ERROR] Tastytrade client secret cannot be empty.
    exit /b 1
)

set /p TASTYTRADE_REFRESH_TOKEN="Enter your Tastytrade OAuth refresh token: "
if "!TASTYTRADE_REFRESH_TOKEN!"=="" (
    echo [ERROR] Tastytrade refresh token cannot be empty.
    exit /b 1
)
...
set /p DASHBOARD_ACCESS_PASSWORD="Enter a dashboard access password (recommended for shared hosting; press Enter to leave unset): "
for /f %%t in ('python -c "import secrets; print(secrets.token_urlsafe(32))"') do set DASHBOARD_SESSION_SECRET=%%t
...
echo.
echo # Broker API
echo ORDER_BROKER=tastytrade
echo TASTYTRADE_ACCOUNT_NUMBER=!TASTYTRADE_ACCOUNT_NUMBER!
echo TASTYTRADE_CLIENT_SECRET=!TASTYTRADE_CLIENT_SECRET!
echo TASTYTRADE_REFRESH_TOKEN=!TASTYTRADE_REFRESH_TOKEN!
echo TASTYTRADE_IS_TEST=false
echo TASTYTRADE_DRY_RUN=true
echo TASTYTRADE_ENTRY_TIME_IN_FORCE=Day
echo TASTYTRADE_EXIT_TIME_IN_FORCE=GTC
echo TASTYTRADE_STOP_ORDER_TYPE=StopLimit
echo ALPACA_API_KEY=
echo ALPACA_SECRET_KEY=
echo WEBHOOK_AUTH_TOKEN=!WEBHOOK_TOKEN!
echo ALPACA_PAPER=true
echo DEFAULT_STOCK_QTY=1
echo WEBHOOK_FORWARD_TARGET=azure
echo WEBHOOK_ACTIVE_MINUTES=60
echo WEBHOOK_MAX_SNAPSHOTS=50
echo AZURE_FUNCTION_APP_NAME=crassus-25
echo AZURE_FUNCTION_BASE_URL=
echo AZURE_SUBSCRIPTION_ID=
echo AZURE_RESOURCE_GROUP=CRG
echo AZURE_LOCATION=eastus
echo AZURE_STORAGE_ACCOUNT=crassusstorage25
echo AZURE_DASHBOARD_APP_NAME=
echo AZURE_DASHBOARD_PLAN_NAME=
echo AZURE_DASHBOARD_SKU=B1
echo DASHBOARD_ACCESS_PASSWORD=!DASHBOARD_ACCESS_PASSWORD!
