...
add_if_set COMMON_FUNCTION_SETTINGS "ALPACA_API_KEY" "$ALPACA_API_KEY"
add_if_set COMMON_FUNCTION_SETTINGS "ALPACA_SECRET_KEY" "$ALPACA_SECRET_KEY"
add_if_set COMMON_FUNCTION_SETTINGS "TASTYTRADE_ACCOUNT_NUMBER" "$TASTYTRADE_ACCOUNT_NUMBER"
add_if_set COMMON_FUNCTION_SETTINGS "TASTYTRADE_CLIENT_SECRET" "$TASTYTRADE_CLIENT_SECRET"
add_if_set COMMON_FUNCTION_SETTINGS "TASTYTRADE_REFRESH_TOKEN" "$TASTYTRADE_REFRESH_TOKEN"
add_if_set COMMON_FUNCTION_SETTINGS "AZURE_SUBSCRIPTION_ID" "$AZURE_SUBSCRIPTION_ID"
...
if [ "$DEPLOY_ENV" = "dev" ]; then
    ...
    add_if_set COMMON_FUNCTION_SETTINGS "ALPACA_PAPER" "$ALPACA_PAPER"
    add_if_set COMMON_FUNCTION_SETTINGS "TASTYTRADE_IS_TEST" "$TASTYTRADE_IS_TEST"
    add_if_set COMMON_FUNCTION_SETTINGS "TASTYTRADE_DRY_RUN" "$TASTYTRADE_DRY_RUN"
    add_if_set COMMON_FUNCTION_SETTINGS "LIVE_TRADING_CONFIRMED" "$LIVE_TRADING_CONFIRMED"
fi
...
add_if_set DASHBOARD_SETTINGS "DASHBOARD_SESSION_SECRET" "$DASHBOARD_SESSION_SECRET"
add_if_set DASHBOARD_SETTINGS "AZURE_SUBSCRIPTION_ID" "$AZURE_SUBSCRIPTION_ID"
