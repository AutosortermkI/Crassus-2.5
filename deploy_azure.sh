...
function_support_files = [
    "function_app/market_data.py",
    "function_app/paper_ledger.py",
...
skip_names = {"local.settings.json", ".options_targets.json", ".webhook_activity.json", ".paper_ledger.json", ".market_data.json"}
...
PAPER_FILL_MODE="$(load_env_var "PAPER_FILL_MODE")"
PAPER_STARTING_CASH="$(load_env_var "PAPER_STARTING_CASH")"
PAPER_LEDGER_CONTAINER="$(load_env_var "PAPER_LEDGER_CONTAINER")"
MARKET_DATA_ENABLED="$(load_env_var "MARKET_DATA_ENABLED")"
MARKET_DATA_CONTAINER="$(load_env_var "MARKET_DATA_CONTAINER")"
MARKET_DATA_WATCHLIST="$(load_env_var "MARKET_DATA_WATCHLIST")"
MARKET_DATA_STALE_SECONDS="$(load_env_var "MARKET_DATA_STALE_SECONDS")"
...
PAPER_FILL_MODE="${PAPER_FILL_MODE:-preflight_only}"
PAPER_STARTING_CASH="${PAPER_STARTING_CASH:-0}"
PAPER_LEDGER_CONTAINER="${PAPER_LEDGER_CONTAINER:-paper-ledger}"
MARKET_DATA_ENABLED="${MARKET_DATA_ENABLED:-false}"
MARKET_DATA_CONTAINER="${MARKET_DATA_CONTAINER:-market-data}"
MARKET_DATA_STALE_SECONDS="${MARKET_DATA_STALE_SECONDS:-60}"
upsert_env_var "TASTYTRADE_IS_TEST" "$TASTYTRADE_IS_TEST"
upsert_env_var "TASTYTRADE_DRY_RUN" "$TASTYTRADE_DRY_RUN"
upsert_env_var "PAPER_FILL_MODE" "$PAPER_FILL_MODE"
upsert_env_var "PAPER_STARTING_CASH" "$PAPER_STARTING_CASH"
upsert_env_var "PAPER_LEDGER_CONTAINER" "$PAPER_LEDGER_CONTAINER"
upsert_env_var "MARKET_DATA_ENABLED" "$MARKET_DATA_ENABLED"
upsert_env_var "MARKET_DATA_CONTAINER" "$MARKET_DATA_CONTAINER"
upsert_env_var "MARKET_DATA_WATCHLIST" "$MARKET_DATA_WATCHLIST"
...
COMMON_FUNCTION_SETTINGS=(
    ...
    "ENABLE_TASTYTRADE_OPTIONS=${ENABLE_TASTYTRADE_OPTIONS:-true}"
    ...
    "PAPER_LEDGER_CONTAINER=$PAPER_LEDGER_CONTAINER"
    "MARKET_DATA_ENABLED=$MARKET_DATA_ENABLED"
    "MARKET_DATA_CONTAINER=$MARKET_DATA_CONTAINER"
